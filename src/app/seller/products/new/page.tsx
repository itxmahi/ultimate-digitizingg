    ...
    <div className="max-w-6xl mx-auto space-y-16 pb-24 relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-10 border-b border-white/5 pb-12">
        ...
        <div className="flex items-center space-x-5">
          ...
          <Button className="h-16 px-12 rounded-2xl luxury-gradient border-none text-white shadow-[0_20px_40px_rgba(37,99,235,0.3)] font-black text-[10px] uppercase tracking-[0.2em] hover:scale-105 active:scale-95 transition-all italic">
            PUBLISH ASSET
          </Button>
        </div>
      </div>
        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <div className="glass p-12 rounded-[3.5rem] border border-white/5 space-y-10">
            ...
            >
              ...
              <Button variant="outline" className="h-16 px-12 rounded-2xl glass border-white/10 font-black text-[10px] uppercase tracking-widest hover:bg-primary hover:text-white transition-all italic">
                BROWSE FILESYSTEM
              </Button>
            </div>

            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-10">
              <div className="aspect-square glass rounded-3xl border border-white/5 border-dashed flex items-center justify-center text-muted-foreground/20 hover:text-primary hover:border-primary/40 transition-all cursor-pointer group shadow-inner">
        ...
        <div className="lg:col-span-4 space-y-12">
          ...
          <div className="glass p-12 rounded-[3.5rem] border border-white/5 space-y-10">
            ...
            <div className="space-y-4">
              ...
              <div className="relative group">
                <select className="w-full bg-white/[0.03] border border-white/5 rounded-[1.5rem] px-8 py-6 text-[11px] font-black uppercase tracking-widest focus:ring-4 ring-primary/10 transition-all outline-none appearance-none shadow-inner italic">
